<template>
	...
	<movie-carousel :showLoader="getting_anime_info" :movies="getting_animes ? [1,2,3,4,5,6,7]: searched" :title="result()" :filteredSeries="selected_genre_names" @navigate="openAnime" :loading="getting_animes"
		:isResult="true"></movie-carousel>
	</div>
</template>
<script>
